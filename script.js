(function(){
  ...
  const mockery = {
    'Quick Hits': [
      ...
      {t:"You're about as threatening as a wet noodle—and just as limp.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your strategy is flaccid—just like your attacks.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"I've seen more penetration from a butter knife.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your blows are softer than a pillow—and about as effective.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You're going down faster than a cheap tavern wench.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your performance is underwhelming—in every sense of the word.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You couldn't satisfy a goblin—and they have low standards.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your attacks are premature—and just as disappointing.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"I've seen more stamina from a dead fish.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your technique is all wrong—but at least you're consistent.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You're harder to satisfy than a rust monster in a jewelry store.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your performance is like your love life—quick and disappointing.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"I've seen more thrust from a training dummy.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You couldn't get it up if your life depended on it—and it does.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your attacks are softer than a feather bed—and just as satisfying.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You finish faster than a kobold in a brothel.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your stamina is shorter than a halfling's attention span.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You're about as hard as a wet noodle—and just as useful.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"I've seen more action from a celibate paladin.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your technique is like your social life—nonexistent.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You couldn't satisfy a succubus if she was paid to pretend.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your performance is premature—just like everything else about you.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"You're going down faster than a tavern wench on payday.", s:"Blingus' Battle Burns", a:"Mockery"},
      {t:"Your attacks are limp—just like your everything else.", s:"Blingus' Battle Burns", a:"Mockery"}
    ],
